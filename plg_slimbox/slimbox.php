...
class plgContentSlimbox extends JPlugin
{
    ...
    */
    function plgContentSlimbox ( &$subject, $config )
	{
		...
		$this->_plugin = JPluginHelper::getPlugin( 'content', 'slimbox' );
    ...
    */
    ...
    {
		$assets = JURI::base() . 'media/libraries/slimbox/';

		//	Add CSS		
		JHTML::_('stylesheet', 'slimbox.css', $assets);	
		
		//	Add Javascript
		$jsfw = $this->_params->get( 'framework', 'moo11' );		
		if	(in_array($jsfw, array('moo11, moo12')))
			JHTML::_( 'behavior.mootools' );
			
		$map= array( 
			'moo11' => 'slimbox.mootools.111.js', 	
			'moo12' => 'slimbox.mootools.122.js', 	
			'jquery' => 'slimbox.jquery.126.js' ); 	
		JHTML::_('script', $map[$jsfw], $assets);			
		// epsi to do: follow joomla version, 1.5 or 1.6
